...
#
#CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --standalone --nnodes=1 --nproc_per_node=$nodes src/sample.py \
#                    --stamp $stamp \
#                    --cfg $cfg \
...
state_epoch=1
#pretrained_model_path='./saved_models/bird/pretrained/state_epoch_1990_0615_w1.pth'
pretrained_model_path='./saved_models/coco/pretrained/state_epoch_300.pth'
log_dir='new'
...
CUDA_VISIBLE_DEVICES=0 torchrun --standalone --nnodes=1 --nproc_per_node=$nodes src/sample.py \
                    --stamp $stamp \
                    --cfg $cfg \
                    --mixed_precision $mixed_precision \
                    --log_dir $log_dir \
